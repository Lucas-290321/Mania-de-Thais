        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <Link
                to="/Sobre"
                className="inline-block px-10 py-4 border-2 border-[#c89b5b] text-[#c89b5b] font-bold text-lg rounded-lg transition-all duration-300 hover:bg-[#c89b5b] hover:shadow-[#c89b5b] active:scale-95"
              >
